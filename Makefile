...
.PHONY: help up down build shell install test test-coverage coverage-check cs-check cs-fix qa clean assets release-check composer-sync ensure-up phpstan rector rector-dry update validate setup-hooks
